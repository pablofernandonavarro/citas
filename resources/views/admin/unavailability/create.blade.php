<x-admin-layout
title="Crear Período de Bloqueo" :breadcrumbs="[
    ...
    [
        'name' => 'Crear',
        'href' => route('admin.unavailability.create'),
    ],
]">
   
    <x-wireui-card>
        <form action="{{ route('admin.unavailability.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Hora Inicio (oculto por defecto) -->
                <div id="start_time_field" class="hidden">
                ...
                <!-- Hora Fin (oculto por defecto) -->
                <div id="end_time_field" class="hidden">
